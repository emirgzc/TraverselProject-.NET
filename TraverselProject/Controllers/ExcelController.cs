        ...
        public IActionResult DestinationExcelReport()
        {
            using (var workbook = new XLWorkbook())
            {
                ...
                using (var stream = new MemoryStream())
                {
                    ...
                    return File(content, "application/vdn.openxmlformats-officedocument.spreadsheetml.sheet", "Rotalar.xlsx");
                }
            }
        }
    }
}
//return File(bytes, "application/vdn.openxmlformats-officedocument.spreadsheetml.sheet", "Deneme_Test.xlsx");