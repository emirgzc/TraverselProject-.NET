...
namespace DaatAccessLayer.Migrations
{
    ...
    [Migration("20230826102402_mig-add-table-Announcement")]
    partial class migaddtableAnnouncement
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EntityLayer.Concrete.DestImage", b =>
                {
                    b.Property<int>("DestImageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("DestImageID");

                    b.HasIndex("DestinationID");

                    b.ToTable("DestImages");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.ReserStatus", b =>
                {
                    b.Property<int>("ReserStatusID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("ReserStatusName")
                        .HasColumnType("nvarchar(max)");

                    b.HasKey("ReserStatusID");

                    b.ToTable("ReserStatus");
                });
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Reservation", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.ReserStatus", "ReserStatus")
                        .WithMany("Reservations")
                        .HasForeignKey("ReserStatusID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
